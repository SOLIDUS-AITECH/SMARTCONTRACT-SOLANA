...
import { loadKeypair, pause, scaffoldProgram, sendTransaction, setBurnRate, setFeeRate, setStakingRate, unpause } from "../sdk";
import path from "node:path";

async function main() {
  const { PaymentGpuMarketplaceProgram, provider, signer } = scaffoldProgram("owner.json");
  ...
  await sendTransaction(
    provider,
    [
      pauseIx, setFeeRateIx, setStakingRateIx,
      setBurnRateIx, unpauseIx
    ],
